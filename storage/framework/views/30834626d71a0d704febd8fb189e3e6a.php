...
<div class="notif-page">
    ...
    <div class="notif-header">
        ...
        <div style="display:flex; gap:10px; align-items:center; flex-wrap:wrap;">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('caregiver.dashboard')); ?>"
    ...
    <?php else: ?>
        ...
        <?php if($unreadItems->isNotEmpty()): ?>
            <div class="notif-section-label">Unread — <?php echo e($unreadItems->count()); ?></div>
            <?php $__currentLoopData = $unreadItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                ?>
                <div class="notif-card <?php echo e($cardClass); ?>">
                    <div class="notif-dot <?php echo e($dotClass); ?>"></div>
                    <div class="notif-icon <?php echo e($iconClass); ?>"><?php echo e($iconChar); ?></div>
                    <div class="notif-body">
                        <div class="notif-card-title"><?php echo e($note->title); ?></div>
                        <div class="notif-card-body"><?php echo e($note->body); ?></div>
                        <div class="notif-card-meta">
                            ...
                            <span>
                                ...
                                <?php echo e($note->device->device_name); ?>
                            ...
                            <span style="color:#94a3b8;"><?php echo e($note->created_at?->format('d M Y, H:i')); ?></span>
                        </div>
                    </div>
                </div>
        ...
        <?php if($readItems->isNotEmpty()): ?>
            <div class="notif-section-label" style="margin-top:24px;">Earlier</div>
            <?php $__currentLoopData = $readItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $evt      = strtolower($note->event_type ?? '');
                    $isCry    = $evt === 'cry_detected';
                    $isDht    = $evt === 'dht';
                ...
                <div class="notif-card" style="opacity:.7;">
                    ...
                    <div class="notif-icon <?php echo e($iconCls); ?>" style="opacity:.6;"><?php echo e($iconChar); ?></div>
                    <div class="notif-body">
                        <div class="notif-card-title" style="color:#334155;"><?php echo e($note->title); ?></div>
                        <div class="notif-card-body" style="color:#64748b;"><?php echo e($note->body); ?></div>
                        <div class="notif-card-meta">
                            <?php if($note->device): ?>
                            <span>
                                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>
                            ...
                            <?php endif; ?>
                            <span><?php echo e($note->created_at?->format('d M Y, H:i')); ?></span>
        ...
        <?php if($notifications instanceof \Illuminate\Pagination\LengthAwarePaginator && $notifications->hasPages()): ?>
