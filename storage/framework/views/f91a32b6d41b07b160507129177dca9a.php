...
<div class="rpt-page">
    ...
    <div class="rpt-page-header">
        ...
        <div class="export-row" style="margin-bottom:0;">
            <a href="<?php echo e($csvUrl); ?>" class="btn-exp btn-exp-csv">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
                Export CSV
            </a>
            <a href="<?php echo e($pdfUrl); ?>" class="btn-exp btn-exp-pdf" target="_blank">
    ...
    <div class="kpi-grid">
        ...
        <div class="kpi-card kpi-slate">
            ...
            <div class="kpi-value" style="font-size:1rem; line-height:1.4;">
                <?php if($dateMin): ?>
                    <?php echo e($dateMin); ?><br><span style="font-size:.8rem; opacity:.6;">to <?php echo e($dateMax); ?></span>
                <?php else: ?>
                    —
                <?php endif; ?>
            </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 20px;">
            ...
            <div class="rpt-panel">
                ...
                <div class="rpt-panel-body">
                    <form method="GET" action="<?php echo e(route('family.reports')); ?>" style="display:flex; flex-direction:column; gap:14px;">
                        <div class="filter-field">
                            <label>Device search</label>
                            <input type="text" name="q" placeholder="Name or token…" value="<?php echo e(request('q')); ?>">
                        </div>
                        <div class="filter-field">
                        ...
                        <div style="display:flex; gap:8px; margin-top:4px;">
                            ...
                            <a href="<?php echo e(route('family.reports')); ?>" class="btn-filter-reset">Reset</a>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="rpt-panel">
                ...
                <div class="rpt-panel-body">
                    <div class="breakdown-row">
                        <?php $__currentLoopData = $topDevices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php $pct = $total > 0 ? round(($count/$total)*100) : 0; ?>
                        <div>
                            <div class="breakdown-item-label">
                                <span><?php echo e($name); ?></span>
                                <span style="color:#64748b;"><?php echo e($count); ?></span>
                            </div>
                            <div class="breakdown-bar-track">
                                <div class="breakdown-bar-fill"
                                     style="width:<?php echo e($pct); ?>%; background: linear-gradient(90deg,#006633,#22c55e);">
                                </div>
                            </div>
                        </div>
                    ...
                    <?php $__currentLoopData = $activities->groupBy(fn($a)=>$a->event_type??'unknown')->map(fn($g)=>$g->count())->sortDesc()->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $evtLabel => $evtCount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <div style="margin-bottom:8px;">
                        <div class="breakdown-item-label">
                            <span><?php echo e($evtLabel); ?></span>
                            <span style="color:#64748b;"><?php echo e($evtCount); ?></span>
                        </div>
                        <div class="breakdown-bar-track">
                            <div class="breakdown-bar-fill" style="width:<?php echo e($evtPct); ?>%; background:<?php echo e($evtColor); ?>;"></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                                ...
                                <td>
                                    <?php if($decoded): ?>
                                        <div class="sensor-row">
                                            <?php if($temp !== null): ?>
                                                <span class="sensor-pill <?php echo e($tempAlert ? 's-crit' : 's-normal'); ?>">
                                                    🌡 <?php echo e($temp); ?>°C
                                                    <?php if($tempAlert): ?> ⚠ <?php endif; ?>
                                                </span>
                                            <?php endif; ?>
                                            <?php if($hum !== null): ?>
                                                <span class="sensor-pill <?php echo e($humAlert ? 's-warn' : 's-normal'); ?>">
                                                    💧 <?php echo e($hum); ?>%
                                                    <?php if($humAlert): ?> ⚠ <?php endif; ?>
                                                </span>
                                            <?php endif; ?>
                                            <?php if($sound !== null): ?>
                                            ...
                                            <?php endif; ?>
                                            <?php if(!$tempAlert && !$humAlert && $sound === null && ($temp !== null || $hum !== null)): ?>
