...
.cg-tbl tbody tr { border-bottom:1px solid #f1f5f9; transition:background .1s; }
.cg-tbl tbody tr:hover { background:#f8fafc; }
.cg-tbl tbody td { padding:12px 16px; font-size:.875rem; vertical-align:middle; }
            ...
            <table class="cg-tbl">
                <thead>
                    <tr>
                        <th>Caregiver</th>
                        <th>Role</th>
                        <th style="width:220px;">Assign device</th>
    ...
    <div class="cg-panel">
        ...
        <div style="padding:22px;">
            <form method="POST" action="<?php echo e(route('family.addCaregiver')); ?>">
                ...
                <span style="font-size:.78rem;color:#94a3b8;margin-left:10px;">
                    Default password is <code>password123</code> if left blank.
                </span>
            </form>
        </div>
    </div>
