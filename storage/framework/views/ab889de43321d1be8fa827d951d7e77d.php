...
<div class="container-fluid py-4">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('caregiver.reports')); ?>" class="btn btn-primary fw-semibold shadow-sm">
                Incident Reports
            </a>
            <a href="<?php echo e(route('caregiver.notifications')); ?>" class="btn btn-outline-info fw-semibold shadow-sm">
                Notifications
            </a>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm" style="border-radius:16px;">
                <div class="card-header border-0 text-white" style="border-radius:16px 16px 0 0; background: linear-gradient(135deg, #0ea5e9 0%, #22d3ee 100%);">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <span class="badge bg-white text-dark"><?php echo e($devices->count()); ?> device(s)</span>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                <div class="col-12">
                                    <div class="p-3 rounded-3" style="background: linear-gradient(90deg, rgba(16,185,129,.12) 0%, rgba(34,211,238,.10) 100%); border: 1px solid rgba(0,0,0,.06);">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                            <div>
                                                <div class="fw-bold fs-5" style="color:#065f46;"><?php echo e($device->device_name); ?></div>
                                                <div class="text-muted small">Token: <span class="font-monospace"><?php echo e($device->device_token); ?></span></div>
                                            </div>
                                            <div class="d-flex gap-2">
            ...
            <div class="card border-0 shadow-sm" style="border-radius:16px;">
                <div class="card-header border-0 text-white" style="border-radius:16px 16px 0 0; background: linear-gradient(135deg, #198754 0%, #34d399 100%);">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <span class="badge bg-white text-dark"><?php echo e(is_array($notifications) ? count($notifications) : ($notifications->count() ?? 0)); ?> item(s)</span>
                    </div>
                </div>
                <div class="card-body">
                    <?php if(empty($notifications) || (is_object($notifications) && $notifications->count() === 0) || (is_array($notifications) && count($notifications) === 0)): ?>
                        ...
                        <div class="d-flex flex-column gap-3">
                            <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="p-3 rounded-3" style="background: #ffffff; border: 1px solid rgba(0,0,0,.06);">
                                    ...
                                    <div class="fw-semibold"><?php echo e($note->message ?? $note); ?></div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php endif; ?>
            ...
            <div class="card border-0 shadow-sm" style="border-radius:16px; background: linear-gradient(135deg, rgba(14,165,233,.10) 0%, rgba(99,102,241,.10) 100%);">
                <div class="card-body">
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                        ...
                        <a class="btn btn-dark fw-semibold shadow-sm" href="<?php echo e(route('caregiver.reports')); ?>">
