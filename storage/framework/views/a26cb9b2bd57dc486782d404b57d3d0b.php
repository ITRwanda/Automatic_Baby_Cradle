...
<div class="fd-page">
    ...
    <div class="fd-header">
        <div>
            ...
            <p class="fd-sub">Welcome back, <?php echo e(auth()->user()->name); ?></p>
        </div>
        <div style="display:flex; gap:8px; flex-wrap:wrap;">
            <a href="<?php echo e(route('family.reports')); ?>" class="fd-btn-primary">
            ...
            <a href="<?php echo e(route('family.caregivers')); ?>" class="fd-btn-outline">Manage Caregivers</a>
        </div>
    </div>
    ...
    <div class="fd-grid" style="margin-bottom:20px;">
        ...
        <div class="fd-panel">
            ...
            <div class="fd-panel-body">
                <?php $__empty_1 = true; $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="fd-device">
                        <div>
                            <div class="fd-device-name"><?php echo e($device->device_name); ?></div>
                            <div class="fd-device-token"><?php echo e($device->device_token); ?></div>
                        </div>
                        <div style="display:flex;flex-direction:column;align-items:flex-end;gap:4px;">
                            ...
                            <?php if($device->user): ?>
                                <span style="font-size:.72rem;color:#64748b;"><?php echo e($device->user->name); ?></span>
                            <?php else: ?>
        ...
        <div class="fd-panel">
            <div class="fd-panel-hdr" style="background:linear-gradient(135deg,#0f172a,#1e293b);color:#fff;">
                ...
                <a href="<?php echo e(route('family.caregivers')); ?>" style="font-size:.73rem;color:#94a3b8;font-weight:600;text-decoration:none;text-transform:none;letter-spacing:0;">
                    Manage →
                </a>
            </div>
            <div class="fd-panel-body">
                <?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="fd-member">
                        <div class="fd-avatar"><?php echo e(strtoupper(substr($member->name ?? '?', 0, 1))); ?></div>
                        <div style="flex:1;min-width:0;">
                            <div class="fd-member-name"><?php echo e($member->name); ?></div>
                            <div class="fd-member-email"><?php echo e($member->email); ?></div>
                        </div>
        ...
        <div class="fd-panel-hdr" style="background:linear-gradient(135deg,#006633,#009944);color:#fff;">
            ...
            <div style="display:flex;align-items:center;gap:8px;">
                <?php if($unreadCount > 0): ?>
                    <span class="u-badge"><?php echo e($unreadCount); ?> unread</span>
                    <form method="POST" action="<?php echo e(route('notifications.markAllRead')); ?>" style="display:inline;">
                        <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:10px;">
                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <div class="fd-notif <?php echo e($cls); ?>">
                            <div class="fd-notif-title"><?php echo e($icon); ?> <?php echo e($note->title); ?></div>
                            <div class="fd-notif-body"><?php echo e(Str::limit($note->body, 90)); ?></div>
                            <div class="fd-notif-time">
                                <?php if($note->device): ?>
                                    <span>📟 <?php echo e($note->device->device_name); ?></span>
                                <?php endif; ?>
                ...
                <div style="margin-top:16px;text-align:right;">
                    <a href="<?php echo e(route('family.reports')); ?>" class="fd-btn-outline" style="font-size:.78rem;padding:6px 14px;">
