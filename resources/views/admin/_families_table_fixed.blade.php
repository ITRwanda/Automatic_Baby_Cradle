                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-control-plaintext">
                                                ...
                                                <span class="text-muted">({{ optional($family->parent)->email ?? '' }})</span>
                                            </div>
                                            <input type="hidden" name="parent_id" value="{{ $family->parent_id }}">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input
                                                    type="text"
                                                    name="parent_name"
                                                    id="parentNameInput-{{ $family->id }}"
                                                    class="form-control"
                                                    value="{{ optional($family->parent)->name }}"
                                                >
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input
                                                    type="email"
                                                    name="parent_email"
                                                    id="parentEmailInput-{{ $family->id }}"
                                                    class="form-control"
                                                    value="{{ optional($family->parent)->email }}"
                                                >
                                            </div>
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="d-flex justify-content-end gap-2 flex-wrap">
                                                            ...
                                                            {{-- Unassign from family (sets devices.family_id = null) --}}
                                                            <form
                                                                method="POST"
                                                            ...
                                                            {{-- Unassign from family_parent (stored in devices.user_id) --}}
                                                            <form
                                                                method="POST"
